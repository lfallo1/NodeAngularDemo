...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filebulk.com" }, urls = { "https?://(www\\.)?filebulk\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FileBulkCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://filebulk.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(filebulk\\.com)";
    ...
    // mods: scanInfo[One more filename regex], login[Login page = MAIN page]
    ...
    public FileBulkCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "b>Download </b>([^<>\"]*?)</h1><").getMatch(0);
        }
        if (fileInfo[1] == null) {
